...
{
	public class GoldSlouchMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/GoldSlouch"), ModContent.ItemType<GoldSlouchMusicBox>(), ModContent.TileType<GoldSlouchMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<GoldSlouchMusicBoxTile>(), 0);
		}
