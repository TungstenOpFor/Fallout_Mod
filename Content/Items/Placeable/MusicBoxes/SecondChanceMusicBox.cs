...
{
	public class SecondChanceMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/SecondChance"), ModContent.ItemType<SecondChanceMusicBox>(), ModContent.TileType<SecondChanceMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<SecondChanceMusicBoxTile>(), 0);
		}
