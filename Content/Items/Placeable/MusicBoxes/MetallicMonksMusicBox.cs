...
{
	public class MetallicMonksMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/MetallicMonks"), ModContent.ItemType<MetallicMonksMusicBox>(), ModContent.TileType<MetallicMonksMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<MetallicMonksMusicBoxTile>(), 0);
		}
