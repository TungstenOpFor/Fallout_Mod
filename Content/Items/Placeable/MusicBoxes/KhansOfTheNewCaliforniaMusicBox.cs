...
{
	public class KhansOfTheNewCaliforniaMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/KhansOfTheNewCalifornia"), ModContent.ItemType<KhansOfTheNewCaliforniaMusicBox>(), ModContent.TileType<KhansOfTheNewCaliforniaMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<KhansOfTheNewCaliforniaMusicBoxTile>(), 0);
		}
