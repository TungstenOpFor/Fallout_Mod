...
{
	public class BiggestLittleCityInTheWorldMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/BiggestLittleCityInTheWorld"), ModContent.ItemType<BiggestLittleCityInTheWorldMusicBox>(), ModContent.TileType<BiggestLittleCityInTheWorldMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<BiggestLittleCityInTheWorldMusicBoxTile>(), 0);
		}
