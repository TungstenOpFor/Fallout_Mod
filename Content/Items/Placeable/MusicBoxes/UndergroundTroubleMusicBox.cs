...
{
	public class UndergroundTroubleMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/UndergroundTrouble"), ModContent.ItemType<UndergroundTroubleMusicBox>(), ModContent.TileType<UndergroundTroubleMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<UndergroundTroubleMusicBoxTile>(), 0);
		}
