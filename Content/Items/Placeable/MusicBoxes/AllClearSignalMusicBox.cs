...
{
	public class AllClearSignalMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/AllClearSignal"), ModContent.ItemType<AllClearSignalMusicBox>(), ModContent.TileType<AllClearSignalMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<AllClearSignalMusicBoxTile>(), 0);
		}
