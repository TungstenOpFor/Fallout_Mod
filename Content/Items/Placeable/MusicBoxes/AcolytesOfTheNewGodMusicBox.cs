...
namespace Fallout_Mod.Content.Items.Placeable.MusicBoxes
{
    public class AcolytesOfTheNewGodMusicBox : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/AcolytesOfTheNewGod"), ModContent.ItemType<AcolytesOfTheNewGodMusicBox>(), ModContent.TileType<AcolytesOfTheNewGodMusicBoxTile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<AcolytesOfTheNewGodMusicBoxTile>(), 0);
        }
