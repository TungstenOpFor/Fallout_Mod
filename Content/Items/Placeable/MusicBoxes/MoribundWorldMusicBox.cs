...
{
	public class MoribundWorldMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/MoribundWorld"), ModContent.ItemType<MoribundWorldMusicBox>(), ModContent.TileType<MoribundWorldMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<MoribundWorldMusicBoxTile>(), 0);
		}
