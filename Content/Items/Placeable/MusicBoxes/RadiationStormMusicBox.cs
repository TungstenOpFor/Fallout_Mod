...
{
	public class RadiationStormMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/RadiationStorm"), ModContent.ItemType<RadiationStormMusicBox>(), ModContent.TileType<RadiationStormMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<RadiationStormMusicBoxTile>(), 0);
		}
