...
{
	public class TheVaultOfTheFutureMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/TheVaultOfTheFuture"), ModContent.ItemType<TheVaultOfTheFutureMusicBox>(), ModContent.TileType<TheVaultOfTheFutureMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<TheVaultOfTheFutureMusicBoxTile>(), 0);
		}
