...
{
	public class MyChrysalisHighwaymanMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/MyChrysalisHighwayman"), ModContent.ItemType<MyChrysalisHighwaymanMusicBox>(), ModContent.TileType<MyChrysalisHighwaymanMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<MyChrysalisHighwaymanMusicBoxTile>(), 0);
		}
