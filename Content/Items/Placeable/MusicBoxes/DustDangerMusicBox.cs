...
{
	public class DustDangerMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/DustDanger"), ModContent.ItemType<DustDangerMusicBox>(), ModContent.TileType<DustDangerMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<DustDangerMusicBoxTile>(), 0);
		}
