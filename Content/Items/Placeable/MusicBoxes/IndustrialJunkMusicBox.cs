...
{
	public class IndustrialJunkMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/IndustrialJunk"), ModContent.ItemType<IndustrialJunkMusicBox>(), ModContent.TileType<IndustrialJunkMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<IndustrialJunkMusicBoxTile>(), 0);
		}
