...
{
	public class VatsOfGooMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/VatsOfGoo"), ModContent.ItemType<VatsOfGooMusicBox>(), ModContent.TileType<VatsOfGooMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<VatsOfGooMusicBoxTile>(), 0);
		}
