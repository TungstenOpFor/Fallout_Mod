...
{
	public class CityOfLostAngelsMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/CityOfLostAngels"), ModContent.ItemType<CityOfLostAngelsMusicBox>(), ModContent.TileType<CityOfLostAngelsMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<CityOfLostAngelsMusicBoxTile>(), 0);
		}
