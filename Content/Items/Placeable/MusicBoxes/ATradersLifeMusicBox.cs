...
{
	public class ATradersLifeMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/ATradersLife"), ModContent.ItemType<ATradersLifeMusicBox>(), ModContent.TileType<ATradersLifeMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<ATradersLifeMusicBoxTile>(), 0);
		}
