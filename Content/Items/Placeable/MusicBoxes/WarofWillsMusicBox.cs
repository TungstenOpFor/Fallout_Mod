...
{
	public class WarofWillsMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/WarofWills"), ModContent.ItemType<WarofWillsMusicBox>(), ModContent.TileType<WarofWillsMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<WarofWillsMusicBoxTile>(), 0);
		}
