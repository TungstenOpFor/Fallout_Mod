...
{
	public class CaliforniaRevisitedMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/CaliforniaRevisited"), ModContent.ItemType<CaliforniaRevisitedMusicBox>(), ModContent.TileType<CaliforniaRevisitedMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<CaliforniaRevisitedMusicBoxTile>(), 0);
		}
