...
{
	public class FlameOfTheAncientWorldMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/FlameOfTheAncientWorld"), ModContent.ItemType<FlameOfTheAncientWorldMusicBox>(), ModContent.TileType<FlameOfTheAncientWorldMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<FlameOfTheAncientWorldMusicBoxTile>(), 0);
		}
