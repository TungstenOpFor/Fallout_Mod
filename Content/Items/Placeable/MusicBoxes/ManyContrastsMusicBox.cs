...
{
	public class ManyContrastsMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/ManyContrasts"), ModContent.ItemType<ManyContrastsMusicBox>(), ModContent.TileType<ManyContrastsMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<ManyContrastsMusicBoxTile>(), 0);
		}
