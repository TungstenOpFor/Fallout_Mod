...
{
	public class FollowersCredoMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/FollowersCredo"), ModContent.ItemType<FollowersCredoMusicBox>(), ModContent.TileType<FollowersCredoMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<FollowersCredoMusicBoxTile>(), 0);
		}
