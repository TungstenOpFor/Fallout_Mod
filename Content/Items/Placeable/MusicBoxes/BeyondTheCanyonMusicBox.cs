...
{
	public class BeyondTheCanyonMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/BeyondTheCanyon"), ModContent.ItemType<BeyondTheCanyonMusicBox>(), ModContent.TileType<BeyondTheCanyonMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<BeyondTheCanyonMusicBoxTile>(), 0);
		}
