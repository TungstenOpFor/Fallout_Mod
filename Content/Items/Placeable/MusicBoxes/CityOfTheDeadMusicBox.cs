...
{
	public class CityOfTheDeadMusicBox : ModItem
	{
		public override void SetStaticDefaults() {
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/CityOfTheDead"), ModContent.ItemType<CityOfTheDeadMusicBox>(), ModContent.TileType<CityOfTheDeadMusicBoxTile>());
		}

		public override void SetDefaults() {
			Item.DefaultToMusicBox(ModContent.TileType<CityOfTheDeadMusicBoxTile>(), 0);
		}
